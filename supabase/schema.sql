...
-- plan_data JSONB stores array of plan items:
-- [{problem_id, type: 'revision'|'new', status: 'pending'|'completed'|'skipped',
--   difficulty, category, estimated_minutes}]
-- =============================================================================
